        ...
        <Container id='about'>
          <Card className={theme.cardOv}>
            ...
            <Row middle='xs' center='xs'>
              ...
              <Col xs={12} md={8}>
                <p className={theme.p}>
                  I’m trying to help solve some of the world’s biggest problems in my lifetime.
                  ...
                  I grew up in San Jose California, but I’m hoping I’m able to make people’s lives all over the world just a
                  little bit better in the future.
                </p>
              </Col>
            </Row>
          </Card>
