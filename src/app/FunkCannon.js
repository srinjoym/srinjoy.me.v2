        ...
        <div className={theme.bg}>
            <Container>
                ...
                <div className={theme.vidcontainer}>
                  <iframe src="http://www.youtube.com/embed/6LP_wzg0UKI" frameborder="0" allowfullscreen></iframe>
                </div>
            </Container>
        </div>
        <Container >
            <Card className={theme.card}>
              ...
              <img className={theme.max_width} src={require("../../img/field.png")}></img>
            </Card>
            <Card className={theme.card}>
              <h2>Stats</h2>
              <Row middle="xs">
            ...
            <li>During the autonomous period, the Funk Cannon is capable of rapidly shooting two balls within 8 seconds, scoring 45 points by itself.</li>
                ...
                <Col xs={12} md={6}>
                  <img className={theme.max_width} src={require("../../img/funkcannon.png")}></img>
                </Col>
              </Row>
            </Card>
            <Card className={theme.card}>
              ...
              <img className={theme.img_width} src={require("../../img/intel.jpg")}></img>
            </Card>
            <Card className={theme.card}>
              <h2>Awards</h2>
              <Row middle="xs">
