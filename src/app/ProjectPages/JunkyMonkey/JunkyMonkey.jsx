      ...
      <div>
        ...
        <Container >
          <Card className={theme.card}>
            ...
            <img className={theme.max_width} src={require('../../../../img/rrfield.png')} />
          </Card>
          <Card className={theme.card}>
            <h2>Stats</h2>
            <Row middle='xs'>
              ...
              <Col xs={12} md={6}>
                <img className={theme.max_width} src={require('../../../../img/junkymonkeyclose.jpg')} />
              </Col>
            </Row>
          </Card>
          <Card className={theme.card}>
          ...
          <Card className={theme.card}>
            ...
            <img className={theme.img_lift} src={require('../../../../img/lift.png')} />
          </Card>
          <Card className={theme.card}>
            <h2>Flexible Worm Gearbox</h2>
            <img className={theme.img_gear} src={require('../../../../img/worm-flexible.png')} />
          ...
          <Card className={theme.card}>
            ...
            <img className={theme.img_width} src={require('../../../../img/counterbalancepic.png')} />
            <p> The gearbox was not able to output enough power to lift up a stack of 6 totes and a container by itself. Because of this, we determined that we needed an additional source of force to alleviate the stress on the worm gearbox. To do this, we used a Negator Spring Motor Assembly from SDP-SI that had a spring torque rating of 15.5 lb-in. We decided to use this spring assembly because it worked well on our 2011 robot, which had a similar elevator design.</p>
          ...
          <Card className={theme.card}>
            ...
            <img className={theme.img_small_width} src={require('../../../../img/Chain.png')} />
