      ...
      <div>
        ...
        <Container >
          <Card className={theme.card}>
            ...
            <img className={theme.max_width} src={require('../../../../img/ultimatefield.png')} />
          </Card>
          <Card className={theme.card}>
            <h2>Stats</h2>
            <Row middle='xs'>
              ...
              <Col xs={12} md={6}>
                <img className={theme.max_width} src={require('../../../../img/ufo_card.png')} />
              </Col>
            </Row>
          </Card>
          <Card className={theme.card}>
            ...
            <img className={theme.img_width} src={require('../../../../img/ufohang.jpg')} />
          </Card>
          <Card className={theme.card}>
            <h2>Awards</h2>
            <Row middle='xs'>
